...
public class Operatorler {
	...
	private boolean greaterThanOrEqulaTest;
	...
	public boolean isGreaterThanOrEqulaTest() {
		return greaterThanOrEqulaTest;
	}

	public void setGreaterThanOrEqulaTest(boolean greaterThanOrEqulaTest) {
		this.greaterThanOrEqulaTest = greaterThanOrEqulaTest;
	}
